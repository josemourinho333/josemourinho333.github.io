...
const Latest = () => {
  ...
  return (
    <div className="min-h-screen bg-neutral-content text-neutral flex flex-col justify-center items-center pt-[5rem]">
      ...
      <div className="bg-neutral-content overflow-clip h-[500px] flex mt-10 w-full">
        <img src="https://cdn.shopify.com/s/files/1/0561/8477/files/Divine-Feminine-Tarot-NOCTURNAL-22.png?v=1606221524" alt="card" className="h-[90%] rounded-box m-auto z-10 rotate-12"/>
      </div>
    </div>
  )
}
