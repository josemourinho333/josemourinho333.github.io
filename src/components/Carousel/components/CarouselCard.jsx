...
const CarouselCard = () => {
  ...
  return (
    <div
      id="carousel-card"
      className="rounded-lg ease-in-out duration-300 flex flex-col"
    >
      <div className="flex-grow flex flex-col p-4">
        <AiOutlineGithub className="w-8 h-8 text-primary rounded-lg p-1" style={{
      ...
      <button className="btn btn-primary flex items-center gap-2 rounded-lg flex-grow-0 hover:bg-primary-content/50 hover:text-primary hover:border-none">
